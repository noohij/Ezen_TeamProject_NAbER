		...
		<form method="post">
			...
			<div class="checkListDiv">
				...
				<div id="check2" class="checkboxDiv">
					...
					<label for="term1">
						<span class="required">[필수]</span> 네이버 이용약관
					</label>
					<a href="">
						<img src="../images/arrowRight.JPG" class="arrow">
					</a>
					<div class="termBox">
						<span>여러분을 환영합니다. 네이버 서비스 및 제품(이하 ‘서비스’)을 
						...
						잠시 시간을 내시어 주의 깊게 살펴봐 주시기 바랍니다.</span>
					</div>
				</div>
...
<!-- 					</a> -->
					...
					서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.</span></div>
				</div>
	
				<div id="check4" class="checkboxDiv">
					<input type="checkbox" id="term3">
					<label for="term3">
						<span class="optional">[선택]</span> 실명 인증된 아이디로 가입
					</label>
					<div class="termBox">
						<span>실명 인증된 아이디로 가입하시면 본인인증이 필요한 서비스 (네이버 페이,
						쇼핑, 멤버십 등)를 가입 후 바로 이용하실 수 있어요.</span>
					</div>
				</div>
				...
				<div id="check5" class="checkboxDiv">
					...
					<div class="termBox">
						<span>위치기반서비스 이용약관에 동의하시면, 위치를 활용한 광고 정보 수신 등을
						...
						사업자로부터 위치정보를 전달받아 아래와 같은 위치기반서비스를 제공합니다.</span>
					</div>
				</div>
