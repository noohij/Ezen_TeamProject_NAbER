...
@WebServlet("/FindNaverId")
public class FindNaverIdServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) 
		...
		//jsp에서 정보 받을 객체 만들기
		RequestDispatcher rd = req.getRequestDispatcher("../findNaverId.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) 
		...
		try {
			...
			String id = memberDao.memberIdCert(name, phonenumber);//name,폰번매개 변수로 가져가서 exist 돌린 애들을 리턴값 반환해주는 dto에 담기
...
//			HttpSession session = req.getSession();
		...
		//회원이 존재한다면 세션에 담고 리턴
//		if (id != null) {
			req.getRequestDispatcher("./auth/findNaverId.jsp").forward(req, res);
//			memberDto = res.getParameter("memberDto");
//			session.setAttribute("member", memberDto);
//			res.sendRedirect("../auth/findNaverId.jsp");
//		}
